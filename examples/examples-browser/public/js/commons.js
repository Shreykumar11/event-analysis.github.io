...
function renderNavBar(navbarId, exampleUri) {
  const examples = [
    ...
    },
    {
      ...
      name: 'Audience Face Recognition'
    },
    /*{
  ...
  action.classList.add('waves-effect', 'waves-light', 'side-by-side')
  action.id = 'event-style'
  const h5 = document.createElement('h5')
  h5.innerHTML = 'Event Analyzer'
  action.appendChild(h5)
  const actionIcon = document.createElement('img')
  actionIcon.src = 'event_analyzer_icon.png'
